Pod::Spec.new do |spec|
  ...
  spec.name         = "CustomRoundedViewIksan"
  spec.version      = "0.0.1"
  ...
  spec.homepage     = "https://github.com/iksanul15/CustomRoundedViewIksan"
  ...
  spec.author             = { "iksanul15" => "iksanul15@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/iksanul15/CustomRoundedViewIksan.git", :tag => "#{spec.version}" }

  # Replace value of source file with your Path
  spec.source_files  = "CustomRoundedViewIksan/**/*.{swift}"
